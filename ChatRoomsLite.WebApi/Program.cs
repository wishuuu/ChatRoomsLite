...
using ChatRoomsLite.Infrastructure;
using ChatRoomsLite.Infrastructure.Repositories;
using ChatRoomsLite.Models.Repositories;
using ChatRoomsLite.WebApi.Hubs;
...
builder.Services
    ...
    {
        opts.UseSqlite("Data Source=chatrooms.db");
    });
...
builder.Services
    ...
    .AddScoped<IRoomInvitationService, RoomInvitationService>();
